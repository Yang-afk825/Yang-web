...
SCRIPTS: Dict[str, ScriptMeta] = {
    ...
    # === v1.4 Smart Solver Engine ===
    "smart_solver": {
        "name": "../core/smart_solver.py",
        "title": "智能多类型解题引擎",
        "category": "web",
        "description": "自动分类Web/PWN/Reverse/Crypto/Misc/Blockchain并路由求解，集成所有payloads",
        "usage": "python core/smart_solver.py web <url> | crypto <text> | binary <file> | batch <json>",
        "deps": [],
        "input_type": "url",
        "output_type": "flag",
    },
    "web_enhanced_solver": {
        "name": "../core/smart_solver.py",
        "title": "增强Web求解器 (SSTI+RCE+SSRF+Upload)",
        "category": "web",
        "description": "集成SSTI/RCE/SSRF/LFI/SQLi/Upload探测的增强Web自动求解器",
        "usage": "python core/smart_solver.py web <url>",
        "deps": [],
        "input_type": "url",
        "output_type": "flag",
    },
    "binary_analyzer": {
        ...
        "title": "二进制分析器 (PE/ELF)",
        "category": "reverse",
        "description": "PE/ELF/APK文件类型检测、字符串提取、保护机制分析、flag搜索",
        "usage": "python core/smart_solver.py binary <file>",
        "deps": [],
        "input_type": "file",
        "output_type": "text",
    },
    "crypto_auto_solver": {
        ...
        "title": "密码自动求解器",
        "category": "crypto",
        "description": "链式Base解码/XOR爆破/ROT爆破/Hash识别自动求解",
        "usage": "python core/smart_solver.py crypto <ciphertext>",
        "deps": [],
        "input_type": "text",
        "output_type": "decode",
    },
    "blockchain_analyzer": {
        ...
        "title": "区块链合约分析器",
        "category": "blockchain",
        "description": "Solidity源码漏洞扫描、EVM字节码分析、常见DeFi攻击模式检测",
        "usage": "python core/smart_solver.py blockchain <source.sol>",
        "deps": [],
        "input_type": "file",
        "output_type": "text",
    },
    "misc_analyzer": {
        ...
        "title": "Misc智能分析器",
        "category": "misc",
        "description": "自动识别文件类型(PNG/ZIP/WAV/PCAP等)并提供隐写/取证解题提示",
        "usage": "python core/smart_solver.py misc <file>",
        "deps": [],
        "input_type": "file",
        "output_type": "text",
    },
    ...
    # === v2.2 SQLi-LABS 专项 ===
    "sqli_labs_solver": {
        "name": "../core/sqli_labs_solver.py",
        "title": "SQLi-LABS 专项求解器",
        "category": "web",
        "description": "65+关SQL注入靶场自动求解：闭合检测→列数探测→数据提取→Flag获取，支持报错/布尔/时间/堆叠/双查询",
        "usage": "python core/sqli_labs_solver.py interactive | solve N | batch S E",
        "deps": [],
        "input_type": "url",
        "output_type": "flag",
    },
    "sqli_labs_gui": {
        "name": "../core/sqli_labs_solver.py",
        "title": "SQLi-LABS GUI面板",
        "category": "web",
        "description": "GUI版SQLi-LABS求解器：关卡选择→一键注入→实时显示结果，支持批量求解",
        "usage": "启动Yang-Web GUI后选择「SQLi靶场」标签页",
        "deps": [],
        "input_type": "url",
        "output_type": "flag",
    },
    ...
    # === v2.2 JS/客户端挑战 ===
    "js_challenge_solver": {
        "name": "../core/js_challenge_solver.py",
        "title": "JS/游戏挑战求解器",
        "category": "web",
        "description": "客户端挑战自动分析：提取硬编码Flag、作弊码(Konami)、游戏类型检测、生成控制台命令",
        "usage": "python core/js_challenge_solver.py <URL>",
        "deps": [],
        "input_type": "url",
        "output_type": "flag",
    },
    "js_game_gui": {
        ...
        "title": "JS游戏分析 GUI面板",
        "category": "web",
        "description": "GUI版JS挑战分析器：URL粘贴→自动提取Flag+作弊码+控制台命令",
        "usage": "启动Yang-Web GUI后选择「JS游戏」标签页",
        "deps": [],
        "input_type": "url",
        "output_type": "flag",
    },
